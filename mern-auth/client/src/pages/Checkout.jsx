...
{/* FIXED: Re-added Transaction ID and Last 4 Digits inputs along with dynamic number banner */}
          {formData.paymentMethod !== 'cod' && (
            <div className="flex flex-col gap-4 p-6 bg-rose-50 rounded-3xl border border-rose-100">
              
              {/* Dynamic Instruction Banner */}
              <div className="p-4 bg-white rounded-2xl border border-rose-200 text-center shadow-sm">
                <p className="text-xs font-black text-gray-700 uppercase tracking-wider mb-1">
                  Please Send Money to our official account:
                </p>
                <p className="text-xl font-black text-rose-600 tracking-wide select-all">
                  01595388867
                </p>
                <p className="text-[10px] text-gray-400 font-bold mt-1 uppercase">
                  (Type: Personal {formData.paymentMethod})
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input required name="transactionId" value={formData.transactionId} onChange={onChangeHandler} className="w-full p-4 bg-white border border-rose-200 rounded-2xl outline-none text-sm" placeholder="e.g. 8N7X6W" />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase text-rose-400 ml-2">Last 4 Digits</label>
                  <input required name="lastFourDigits" value={formData.lastFourDigits} onChange={onChangeHandler} className="w-full p-4 bg-white border border-rose-200 rounded-2xl outline-none text-sm" placeholder="e.g. 4455" />
                </div>
              </div>
